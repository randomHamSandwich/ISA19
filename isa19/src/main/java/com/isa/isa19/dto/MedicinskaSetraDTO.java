...
import com.isa.isa19.model.MedicinskaSestra;

public class MedicinskaSetraDTO {
//
//	public long idOsoba;
...
//	
//	public MedicinskaSetraDTO(MedicinskaSestra s) {
//		this(s.getIdOsoba(),s.getEmail(),s.getLozinka(),s.getIme(),s.getPrezime(),s.getUlica(),s.getBrojUlice(),s.getGrad(),s.getDrzava(),s.getBrojTelefona(),s.getJmbg());
//	}
//	
//	public MedicinskaSetraDTO() {
//		super();
//		// TODO Auto-generated constructor stub
//	}
//	public MedicinskaSetraDTO(long idOsoba, String email, String lozinka, String ime, String prezime, String ulica,
