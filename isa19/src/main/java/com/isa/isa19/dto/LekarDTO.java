...
public class LekarDTO {
	...
	public LekarDTO(Lekar l) {
		this(l.getIdOsoba(), l.getEmail(), l.getLozinka(), l.getIme(), l.getPrezime(), l.getUlica(), l.getBrojUlice(),
				l.getGrad(), l.getDrzava(), l.getBrojTelefona(), l.getJmbg(), l.getOcenaLekar(),
				l.getSpecijalizacija());
	}
	...
	public LekarDTO(long idOsoba, String email, String lozinka, String ime, String prezime, String ulica,
			String brojUlice, String grad, String drzava, String brojTelefona, String jmbg, float ocenaLekar,
