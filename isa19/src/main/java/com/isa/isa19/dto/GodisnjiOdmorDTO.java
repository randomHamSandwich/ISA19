...
import com.isa.isa19.model.GodisnjiOdmor;
...
public class GodisnjiOdmorDTO {
	...
	public GodisnjiOdmorDTO(GodisnjiOdmor g) {
		this(g.getIdGodisnjiOdmor(), g.getPocetakRadnogVremena(), g.getKrajRadnogVremena());
	}
	...
	public GodisnjiOdmorDTO(long idGodisnjiOdmor, Date pocetakRadnogVremena, Date krajRadnogVremena) {
		super();
